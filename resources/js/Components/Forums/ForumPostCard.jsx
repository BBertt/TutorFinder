...
export default function ForumPostCard({ post }) {
    ...
    return (
        <Link
            ...
            className="block bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-all hover:bg-gray-200 dark:bg-darkSecondary dark:border-dark dark:hover:bg-gray-700"
        >
            <div className="flex items-start space-x-4">
                <img
                    className={`w-12 h-12 rounded-full ${!post.user
                        .profile_image_path}`}
                    src={
