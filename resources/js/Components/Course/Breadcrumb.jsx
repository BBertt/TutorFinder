...
const Breadcrumb = ({ category, course }) => {
    return (
        <nav
            className="flex px-5 py-3 text-white rounded-sm bg-secondary dark:bg-darkPrimary"
        ...
        >
            <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                <li className="inline-flex items-center">
                    <Link
                        href="/courses"
                        className="ms-1 text-sm font-medium text-gray-400 md:ms-2 dark:hover:text-white"
                    >
                        Courses
                    </Link>
                </li>
