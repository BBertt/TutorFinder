...
const Profile = () => {
    ...
    return (
        <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
            <div className="max-w-lg w-full mx-auto bg-primary p-6 rounded-xl text-white flex flex-col items-center dark:bg-darkSecondary dark:border-dark">
            ...
            {auth?.reviews && (
                <>
                    <section>
                        ...
                        {auth?.reviews?.data?.length > 0 ? (
                            <div className="space-y-6">
                                {auth.reviews.data.map((review) => (
                                    <ReviewCard
                                        key={review.id}
                                        review={review}
                                    />
                    ...
                    {auth?.reviews?.data?.length > 0 && (
                        <Pagination links={auth.reviews.links} />
                    )}
                </>
            )}
        </main>
