            ...
            <div className="flex flex-col items-center gap-4">
                ...
                >
                    <svg className="w-4 h-4 mr-2" viewBox="0 0 48 48">
                        ...
                        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571l6.19,5.238C44.438,36.338,48,30.668,48,24C48,22.659,47.862,21.35,47.611,20.083z"></path>
                    </svg>
                    Sign in with Google
                </a>
